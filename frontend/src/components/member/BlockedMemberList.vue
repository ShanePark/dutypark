    ...
    <div class="p-5">
      ...
      <div v-else class="space-y-2">
        ...
        >
          ...
          <button
            class="flex-shrink-0 px-3 py-2 text-sm font-medium border border-dp-border-secondary rounded-lg hover:bg-dp-bg-hover transition cursor-pointer bg-dp-bg-card text-dp-text-primary"
