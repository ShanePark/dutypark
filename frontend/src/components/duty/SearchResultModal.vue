...
<template>
  <Teleport to="body">
    ...
    >
      <div class="rounded-lg shadow-xl w-full max-w-[95vw] sm:max-w-2xl max-h-[85dvh] sm:max-h-[70vh] mx-2 sm:mx-4 flex flex-col" :style="{ backgroundColor: 'var(--dp-bg-modal)' }">
        <!-- Header -->
