...
<template>
  <Teleport to="body">
    ...
    >
      <div class="rounded-lg shadow-xl overflow-hidden w-full max-w-[95vw] sm:max-w-2xl max-h-[calc(100dvh-5rem)] sm:max-h-[90vh] mx-2 sm:mx-4 flex flex-col" :style="{ backgroundColor: 'var(--dp-bg-modal)' }">
        <!-- Header -->
