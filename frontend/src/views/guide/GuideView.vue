  ...
  <div class="max-w-4xl mx-auto px-4 py-6">
    ...
    <div class="mb-8">
      ...
      <div class="flex items-center gap-3 mb-4">
        ...
        <div>
          <h1 class="text-2xl font-bold text-dp-text-primary">이용 안내</h1>
          <p class="text-sm text-dp-text-secondary">Dutypark의 주요 기능과 사용 방법을 안내합니다</p>
        </div>
      </div>
      ...
      >
        ...
        >
          <div class="flex items-center gap-3">
            ...
            <span class="font-semibold text-dp-text-primary">대시보드 (홈)</span>
          </div>
        ...
        <div v-if="sections.find(s => s.id === 'dashboard')?.isOpen" class="p-5 space-y-6">
          ...
          <div class="space-y-4">
            <div class="p-4 rounded-lg bg-dp-bg-secondary">
            ...
            <div class="p-4 rounded-lg bg-dp-bg-secondary">
              ...
              <ul class="text-sm space-y-1.5 ml-6 text-dp-text-secondary">
                ...
                <li class="flex items-center gap-1">
                  <GripVertical class="w-3 h-3 text-dp-text-muted" />
      ...
      >
        ...
        >
          <div class="flex items-center gap-3">
            ...
            <span class="font-semibold text-dp-text-primary">내 달력</span>
          </div>
      ...
      >
        ...
        >
          <div class="flex items-center gap-3">
            ...
            <span class="font-semibold text-dp-text-primary">내 팀</span>
          </div>
      ...
      >
        ...
        >
          <div class="flex items-center gap-3">
            ...
            <span class="font-semibold text-dp-text-primary">친구 관리</span>
          </div>
      ...
      >
        ...
        >
          <div class="flex items-center gap-3">
            ...
            <span class="font-semibold text-dp-text-primary">설정</span>
          </div>
