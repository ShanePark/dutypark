const apiErrors = {
  auth: {
    ...
    account: {
      suspended: '계정이 이용 정지되었습니다. 이의제기는 문의 페이지를 이용해 주세요.',
    },
    login: {
  ...
  member: {
    ...
    suspend: {
      deletionPending: '삭제 대기 중인 계정은 이용 정지할 수 없습니다.',
    },
  },
  dutyType: {
    abbreviation: {
  ...
  friend: {
    ...
    request: {
      ...
      blocked: '차단한 사용자이거나 나를 차단한 사용자입니다.',
    },
    family: {
  ...
  block: {
    self: '자기 자신은 차단할 수 없습니다.',
  },
  report: {
    self: '내가 올린 콘텐츠는 신고할 수 없습니다.',
    detail: {
...
export default {
  ...
  report: {
    ...
    reasons: {
      spam: '스팸 또는 광고',
      harassment: '괴롭힘 또는 비방',
      inappropriateContent: '음란물 또는 부적절한 콘텐츠',
      impersonation: '사칭',
      other: '기타',
    },
    modal: {
    ...
    messages: {
      submitted: '신고가 접수되었습니다. 24시간 이내에 확인합니다.',
      submitFailed: '신고 접수에 실패했습니다.',
    },
    login: {
      title: '로그인이 필요합니다',
      message: '신고하려면 로그인이 필요합니다.',
      confirm: '로그인하러 가기',
    },
    block: {
      title: '이 사용자를 차단할까요?',
      message: '차단하면 친구 관계가 해제되고 서로의 달력·검색·요청·알림이 차단됩니다. 같은 팀 근무표는 계속 표시됩니다.',
      confirm: '차단',
  ...
  notifications: {
    ...
    list: {
      ...
      loadMore: '더보기',
      deleteConfirmMessage: '“{message}” 알림을 삭제하시겠습니까?',
  ...
  dashboard: {
    ...
    messages: {
      ...
      pinFailed: '친구를 즐겨찾기에 추가하지 못했습니다.',
      unpinFailed: '친구를 즐겨찾기에서 해제하지 못했습니다.',
      unpinTitle: '즐겨찾기 해제',
      unpinConfirm: '{name}님을 즐겨찾기에서 해제할까요?',
  ...
  friends: {
    ...
    help: {
      openAriaLabel: '친구 즐겨찾기 및 순서 도움말',
      title: '즐겨찾는 친구 순서 변경하기',
      pinTitle: '자주 보는 친구를 즐겨찾기에 추가하세요',
      pinText: '별 아이콘을 누르면 즐겨찾는 친구로 추가되어 목록 맨 위에 표시됩니다. 즐겨찾는 친구는 원하는 순서로 바꿀 수 있어요.',
      reorderTitle: '손잡이를 끌어서 옮기세요',
      reorderText: '즐겨찾는 친구가 두 명 이상이면 카드 오른쪽 아래에 손잡이가 나타납니다. 손잡이를 끌어 원하는 자리에 놓으세요.',
      saveTitle: '순서는 자동으로 저장됩니다',
      saveText: '카드를 놓는 순간 바뀐 순서가 저장되어 다른 기기에서도 똑같이 보입니다.',
      note: '즐겨찾기에 추가하지 않은 친구는 기본 순서대로 아래에 표시됩니다.',
    },
    actions: {
      addFriend: '친구 추가',
      approve: '승인',
    ...
    block: {
      action: '차단',
      sectionTitle: '차단한 사용자',
      empty: '차단한 사용자가 없습니다.',
      blockedAt: '{date} 차단',
      unblockAction: '차단 해제',
      confirmTitle: '사용자 차단',
      confirmMessage: '{name}님을 차단하시겠습니까?\n친구 관계가 해제되고 서로의 달력·검색·친구 요청·알림이 차단됩니다. 같은 팀 근무표는 계속 표시됩니다.',
      confirmAction: '차단',
      blockSuccess: '{name}님을 차단했습니다.',
  ...
  todoBoard: {
    ...
    messages: {
      ...
      deleteCompletedTitle: '완료 항목을 정리할까요?',
      deleteCompletedConfirm: '내가 작성한 완료된 할일 {ownedCount}개는 영구적으로 삭제되고, 나에게 태그된 완료된 할일 {taggedCount}개는 내 보드에서만 제거됩니다.',
      deleteCompletedSuccess: '완료 항목을 정리했습니다. 내가 작성한 {deletedCount}개는 삭제했고, 나에게 태그된 {untaggedCount}개는 내 보드에서 제거했습니다.',
    ...
    help: {
      ...
      whatIsKanbanText: '할일을 할일, 진행중, 완료 세 단계로 나누어 관리하는 방식입니다. 카드를 클릭하면 상세 화면에서 상태를 변경할 수 있고, 카드를 드래그해 다른 컬럼으로 옮길 수도 있습니다.',
      todoTitle: '할일 (TODO)',
      ...
      tipsTitle: '사용 팁',
      tips: {
        drag: '카드를 클릭해 상세 화면에서 상태를 변경하거나, 드래그&드롭하여 다른 컬럼으로 옮기세요.',
  ...
  member: {
    ...
    sessions: {
      ...
      signOutCurrentTitle: '접속 세션 종료',
      signOutCurrentConfirm: '{device} · {browser} ({ip}) 세션을 종료하시겠습니까?',
    ...
    accountDeletion: {
      title: '회원 탈퇴', progress: '{total}단계 중 {current}단계', loading: '회원 탈퇴 영향을 확인하고 있습니다...', retentionNotice: '문의·신고 원문과 처리 기록, 그 기록에 포함된 이름 및 콘텐츠 snapshot은 계정 연결 해제 후에도 운영·분쟁 대응 또는 법령상 필요한 범위에서 제한적으로 보관될 수 있습니다. 해당 목적이 달성되면 삭제하거나 익명화합니다.',
      ...
      back: '이전', continue: '계속',
      errors: { load: '회원 탈퇴 영향을 불러오지 못했습니다. 다시 시도해 주세요.', reauthentication: '본인 확인에 실패했습니다. 로그인 수단을 확인하고 다시 시도해 주세요.', transferRequired: '계속하려면 유효한 새 팀 관리자를 선택해 주세요.', transferInvalid: '선택한 팀 관리자를 더 이상 지정할 수 없습니다. 다시 인증한 뒤 다른 구성원을 선택해 주세요.', noTransferCandidate: '팀 관리자 권한을 넘길 수 있는 구성원이 없습니다. 팀 상태를 먼저 정리해 주세요.', impersonation: '다른 계정을 관리 중일 때는 탈퇴할 수 없습니다. 내 계정으로 먼저 돌아와 주세요.', proofExpired: '본인 확인이 만료되었습니다. 다시 인증해 주세요.', nameMismatch: '계정 이름이 정확히 일치하지 않습니다.', oauthPopupBlocked: '인증 창이 차단되었습니다. Dutypark 팝업을 허용한 뒤 다시 시도해 주세요.', oauthPopupClosed: '본인 확인이 끝나기 전에 인증 창이 닫혔습니다.', oauthPopupTimeout: '소셜 본인 확인 시간이 초과되었습니다. 다시 시도해 주세요.', oauthCancelled: '소셜 본인 확인이 취소되었습니다.', oauthAccountMismatch: 'Dutypark에 연결된 계정과 다른 소셜 계정입니다.', oauthProviderFailed: '소셜 제공자에서 본인 확인을 완료하지 못했습니다. 다시 시도해 주세요.', appleRequiresIos: 'Apple 계정 재인증은 웹에서 지원되지 않습니다. Dutypark iOS 앱에서 탈퇴를 진행해 주세요.', receiptStorage: '삭제 요청 확인 정보를 저장할 수 없습니다. 브라우저 저장공간을 확인한 뒤 다시 시도해 주세요.', receiptAlreadyPending: '이 브라우저에 확인하지 않은 삭제 요청이 있습니다. 먼저 삭제 상태를 확인해 주세요.', receiptOwnedByAnotherAccount: '이 브라우저에 다른 계정의 삭제 요청이 있습니다. 먼저 해당 요청의 상태를 확인해 주세요.', receiptMismatch: '삭제 요청 확인 정보가 서버 응답과 일치하지 않습니다. 요청을 다시 전송하지 말고 고객지원에 문의해 주세요.', generic: '회원 탈퇴를 완료하지 못했습니다. 인증 정보는 폐기되었으니 다시 인증해 주세요.' },
      ...
      completion: { acceptedTitle: '회원 탈퇴 요청이 접수되었습니다', alreadyPendingTitle: '회원 탈퇴 요청이 이미 처리 중입니다', signedOut: 'Dutypark에서 안전하게 로그아웃되었습니다.', asyncCleanup: '계정 데이터와 저장 파일을 삭제하고 있습니다. 이 처리는 보통 5분 이내에 완료되며, 문의·신고 기록에는 별도의 보관·삭제 기준이 적용될 수 있습니다.', receiptUnavailable: '삭제 상태 확인 정보를 저장하지 못했습니다. 계정 삭제 요청은 접수되었지만 상태를 확인하려면 고객지원에 문의해 주세요.', contactSupport: '고객지원 문의', confirm: '확인' },
      status: { title: '회원 탈퇴 처리 상태', processingTitle: '회원 탈퇴를 처리하고 있습니다', processingMessage: '계정 데이터와 저장 파일을 안전하게 삭제하고 있습니다. 이 처리는 보통 5분 이내에 완료되며, 문의·신고 기록에는 별도의 보관·삭제 기준이 적용될 수 있습니다.', estimatedAt: '예상 완료 시각: {time}', signedOut: '로그아웃된 상태에서도 이 페이지에서 처리 상태를 확인할 수 있습니다.', refresh: '상태 새로 확인', checkStatus: '삭제 상태 확인하기', recoverStoredReceipt: '저장된 삭제 상태 확인 또는 초기화', checking: '상태를 확인하고 있습니다...', completedTitle: '회원 탈퇴가 완료되었습니다', completedMessage: '탈퇴 화면에서 삭제 대상으로 안내한 계정 데이터와 저장 파일의 처리가 완료되었습니다.', failedTitle: '회원 탈퇴를 완료하지 못했습니다', failedMessage: '삭제 처리 중 문제가 발생했습니다. 고객지원으로 문의해 주세요.', unavailable: '삭제 상태 확인 기간이 만료되었거나 확인할 수 없습니다.', unavailableMessage: '삭제 완료 여부를 확인할 수 없습니다. 필요한 경우 고객지원으로 문의해 주세요.', support: '고객지원 문의', dismiss: '확인', resetStoredReceipt: '저장된 삭제 상태 초기화 후 홈으로', noReceiptTitle: '삭제 상태를 확인할 수 없습니다', noReceiptMessage: '저장된 삭제 요청 확인 정보가 없습니다. 고객지원으로 문의해 주세요.', storedReceiptInvalidMessage: '저장된 삭제 상태 정보가 없거나 이전 버전의 형식입니다. 초기화한 뒤 다시 탈퇴를 요청해 주세요.', retryMessage: '상태를 확인하지 못했습니다. 잠시 후 다시 시도합니다.' },
    },
    logout: '로그아웃',
    logoutDialog: {
      title: '로그아웃',
  ...
  duty: {
    ...
    untagConfirm: {
      title: '태그 제거',
      message: '“{title}” 일정을 내 달력에서 제거하시겠습니까?',
  ...
  team: {
    view: {
      ...
      schedule: {
        ...
        deleteConfirm: '“{title}” 팀 일정을 삭제하시겠습니까?\n삭제된 일정은 복구할 수 없습니다.',
    ...
    manage: {
      ...
      messages: {
        ...
        assignAdminConfirm: '{name} 님을 팀 대표로 지정하시겠습니까?',
        changeAdminConfirm: '정말 {name} 님을 대표로 변경하시겠습니까?\n다시 대표 권한을 획득하려면 {name} 님에게 요청해야 합니다.',
        resetAdminConfirm: '{name} 님의 팀 대표 권한을 초기화하시겠습니까?',
        ...
        deleteTeamConfirm: '“{name}” 팀을 삭제하시겠습니까?',
  ...
  profilePhoto: {
    ...
    useDefault: '기본 이미지로 변경',
    deleteTitle: '기본 이미지로 변경',
    deleteConfirm: '프로필 사진을 기본 이미지로 변경하시겠습니까?',
    deleted: '프로필 사진이 기본 이미지로 변경되었습니다.',
    deleteFailed: '프로필 사진을 기본 이미지로 변경하지 못했습니다.',
  },
  pwaInstallGuide: {
    title: 'Dutypark 설치하기',
    closeAria: '설치 안내 닫기',
  ...
  guide: {
    status: {
      loadingGuide: '이용 안내를 불러오는 중...',
      guideLoadFailed: '이용 안내를 불러오지 못했습니다.',
      loadingReleaseNotes: '릴리스 노트를 불러오는 중...',
      releaseNotesLoadFailed: '릴리스 노트를 불러오지 못했습니다.',
      releaseNotesLoadMoreFailed: '릴리스 노트를 더 불러오지 못했습니다.',
    },
  },
  admin: {
    nav: {
    ...
    dashboard: {
      ...
      messages: {
        ...
        revokeSessionConfirm: '{name}님의 {device} · {browser} ({ip}) 세션을 종료하시겠습니까?',
    ...
    memberDetail: {
      ...
      suspension: {
        statusBadge: {
          active: '정상',
          suspended: '이용 정지',
          deletionPending: '삭제 대기',
        },
        suspend: '계정 정지',
        unsuspend: '정지 해제',
        suspendConfirmTitle: '계정 정지',
        suspendConfirm: '{name}님의 계정을 정지하시겠습니까? 로그인이 차단되고 기존 세션이 모두 종료됩니다.',
        unsuspendConfirmTitle: '정지 해제',
        unsuspendConfirm: '{name}님의 계정 정지를 해제하시겠습니까?',
        suspendSuccess: '{name}님의 계정을 정지했습니다.',
        suspendFailed: '계정 정지에 실패했습니다.',
        unsuspendSuccess: '{name}님의 계정 정지를 해제했습니다.',
        unsuspendFailed: '정지 해제에 실패했습니다.',
        working: '처리 중...',
      },
    },
    reports: {
      title: '신고 관리',
      totalReports: '총 {count}건의 신고가 있습니다',
      empty: '표시할 신고가 없습니다',
      pagination: '총 {total}건 중 {start}-{end}',
      filters: {
        open: '미처리',
        resolved: '처리 완료',
        dismissed: '반려',
      ...
      row: {
        reportedMember: '피신고자 {name}',
        reporter: '신고자 {name}',
      },
      messages: {
        loadFailed: '신고 목록을 불러오는데 실패했습니다.',
        loadDetailFailed: '신고 상세 정보를 불러오는데 실패했습니다.',
        updateStatusSuccess: '신고 상태를 변경했습니다.',
        updateStatusFailed: '신고 상태 변경에 실패했습니다.',
        deleteTargetConfirm: '{name}님의 신고된 콘텐츠를 삭제하시겠습니까? 되돌릴 수 없습니다.',
        deleteTargetSuccess: '신고된 콘텐츠를 삭제했습니다.',
        deleteTargetFailed: '콘텐츠 삭제에 실패했습니다.',
      },
      detail: {
        title: '신고 상세',
        subtitle: '신고 내용과 조치',
        closeAria: '신고 상세 닫기',
        loadingMessage: '신고 상세 정보를 불러오는 중입니다...',
        retry: '다시 불러오기',
        actionsTitle: '조치',
        memoPlaceholder: '처리 내용을 기록하세요 (선택)',
        targetDeleted: '신고된 콘텐츠는 이미 삭제되었습니다.',
        memberTargetNotDeletable: '회원 신고는 콘텐츠 삭제 대신 계정 정지로 처리합니다.',
        fields: {
          reportedAt: '접수일',
          targetId: '대상 ID',
          reporter: '신고자',
        ...
        values: {
          noDetail: '작성된 상세 내용이 없습니다',
          withdrawnMember: '탈퇴한 회원',
          none: '-',
        },
        actions: {
          resolve: '처리 완료',
    ...
    inquiries: {
      title: '문의 관리',
      totalInquiries: '총 {count}건의 문의가 있습니다',
      empty: '표시할 문의가 없습니다',
      pagination: '총 {total}건 중 {start}-{end}',
      filters: {
        open: '미처리',
      ...
      messages: {
        loadFailed: '문의 목록을 불러오는데 실패했습니다.',
      ...
      detail: {
        ...
        subtitle: '문의 내용과 처리',
        closeAria: '문의 상세 닫기',
        loadingMessage: '문의 상세 정보를 불러오는 중입니다...',
        retry: '다시 불러오기',
        actionsTitle: '처리',
        memoPlaceholder: '처리 내용을 기록하세요 (선택)',
  ...
  support: {
    ...
    guide: {
      title: '신고와 차단',
      reportTitle: '신고하기',
      reportDescription: '다른 회원의 달력에서 오른쪽 위 ⋯ 메뉴를 눌러 사용자를 신고할 수 있고, 일정과 할일은 각 항목의 신고 버튼으로 신고할 수 있습니다. 신고하려면 로그인이 필요합니다.',
      blockTitle: '차단하기',
      blockDescription: '친구 관리 화면의 친구 카드 ⋯ 메뉴 또는 상대방 달력의 ⋯ 메뉴에서 차단할 수 있습니다. 차단하면 친구 관계가 해제되고 서로의 달력·검색·친구 요청·알림이 차단됩니다. 같은 팀의 근무표는 계속 표시됩니다. 차단한 사용자는 친구 관리 화면에서 해제할 수 있습니다.',
      handlingTitle: '처리 기준',
      handlingDescription: '접수된 신고는 24시간 이내에 확인하고 콘텐츠 삭제, 계정 이용 정지 등 필요한 조치를 합니다.',
      appealDescription: '계정이 이용 정지된 경우에도 아래 문의 양식으로 이의를 제기할 수 있습니다.',
      termsLink: '이용약관 보기',
    },
    form: {
      title: '문의하기',
      ...
      error: {
        ...
        rateLimit: '문의가 너무 많이 접수되었습니다. 잠시 후 다시 시도해 주세요.',
