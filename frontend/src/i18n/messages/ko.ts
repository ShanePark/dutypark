...
const apiErrors = {
  ...
  aiScheduleConsent: {
    ...
    toggleLabel: 'Google AI로 일정 시간 자동 인식',
    dataFlow: '일정의 날짜와 내용 텍스트만 Google Generative Language API로 전송해 시작·종료 시간을 추출합니다. 회원 ID와 팀 ID는 전송하지 않습니다.',
...
export default {
  ...
  member: {
    ...
    accountDeletion: {
      ...
      reauth: { title: '본인 확인', message: '현재 로그인 수단 중 하나로 다시 인증해 주세요. 인증 정보는 이 창의 메모리에만 잠시 유지됩니다.', password: '현재 비밀번호', passwordAction: '비밀번호로 확인', socialTitle: '또는 연동된 소셜 계정으로 확인', socialAction: '{provider}로 확인', complete: '본인 확인이 완료되었습니다. 계속할 수 있습니다.' },
