...
export default {
  ...
  todoBoard: {
    ...
    messages: {
      ...
      deleteCompletedConfirm: 'Items you created will be deleted. Tagged items will only be removed from your board.',
      deleteCompletedSuccess: 'Completed items cleared.',
