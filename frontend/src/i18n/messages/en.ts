const apiErrors = {
  auth: {
    ...
    account: {
      suspended: 'This account has been suspended. Please use the support page to appeal.',
    },
    login: {
  ...
  member: {
    ...
    suspend: {
      deletionPending: 'An account pending deletion cannot be suspended.',
    },
  },
  dutyType: {
    abbreviation: {
  ...
  friend: {
    ...
    request: {
      ...
      blocked: 'You cannot send a request to a member you blocked or who blocked you.',
    },
    family: {
  ...
  report: {
    self: 'You cannot report your own content.',
    detail: {
...
export default {
  ...
  report: {
    actions: {
      menu: 'More',
      report: 'Report',
      reportMember: 'Report user',
      blockMember: 'Block user',
    },
    targets: {
      member: 'User: {name}',
    ...
    reasons: {
      ...
      inappropriateContent: 'Sexual or inappropriate content',
    ...
    messages: {
      submitted: 'Your report was received. We will review it within 24 hours.',
      submitFailed: 'Failed to submit the report.',
    },
    login: {
    ...
    block: {
      ...
      message: 'Blocking removes the friendship and hides both calendars, search results, requests and notifications from each other. Team duty rosters stay visible.',
      confirm: 'Block',
      success: 'Blocked {name}.',
      failed: 'Failed to block this user.',
    },
  },
  visibility: {
    labels: {
  ...
  dashboard: {
    ...
    messages: {
      ...
      pinFailed: 'Failed to add the friend to your favorites.',
      unpinFailed: 'Failed to remove the friend from your favorites.',
      unpinTitle: 'Remove from favorites',
      unpinConfirm: 'Remove {name} from your favorites?',
  ...
  friends: {
    ...
    help: {
      openAriaLabel: 'How to favorite and reorder friends',
      title: 'Reorder favorite friends',
      pinTitle: 'Add friends you check often to your favorites',
      pinText: 'Tap the star to add a friend to your favorites. Favorite friends move to the top and can be reordered.',
      reorderTitle: 'Drag the handle to move a friend',
      reorderText: 'Once two or more friends are in your favorites, a handle appears at the bottom right of each card. Drag it to the position you want.',
      ...
      note: 'Friends not in your favorites stay below in the default order.',
    },
    actions: {
      addFriend: 'Add friend',
      approve: 'Approve',
    ...
    block: {
      ...
      confirmMessage: 'Block {name}?\nYour friend connection is removed, and you stop seeing each other in calendars, search, friend requests and notifications. Team duty rosters stay visible.',
      confirmAction: 'Block',
  ...
  todoBoard: {
    ...
    messages: {
      ...
      deleteCompletedTitle: 'Clear completed items?',
      deleteCompletedConfirm: '{ownedCount} completed tasks you created will be permanently deleted. {taggedCount} completed tasks tagged to you will be removed from your board only.',
      deleteCompletedSuccess: 'Cleared completed items: {deletedCount} deleted and {untaggedCount} removed from your board.',
    ...
    help: {
      ...
      whatIsKanbanText: 'A Kanban board helps you manage tasks in three stages: To-do, In progress, and Done. Click a card to change its status in the detail view, or drag it to another column.',
      ...
      tipsTitle: 'Tips',
      tips: {
        drag: 'Click a card to change its status in the detail view, or drag and drop it to another column.',
  ...
  member: {
    ...
    accountDeletion: {
      ...
      errors: {
        ...
        receiptStorage: 'The deletion receipt could not be saved. Check your browser storage and try again.',
        receiptAlreadyPending: 'This browser has an unconfirmed deletion request. Check its status before starting another request.',
        receiptOwnedByAnotherAccount: 'This browser has a deletion request for another account. Check that request status before starting a new one.',
        receiptMismatch: 'The deletion receipt did not match the server response. Do not resubmit the request; contact support.',
      ...
      status: {
        ...
        completedTitle: 'Account deletion is complete',
        completedMessage: 'Processing is complete for the account data and stored files identified for deletion on the deletion screen.',
        failedTitle: 'Account deletion could not be completed',
        failedMessage: 'Something went wrong while processing the deletion. Contact support for help.',
        unavailable: 'The deletion status window has expired or the status cannot be checked.',
        unavailableMessage: 'We could not confirm whether the deletion completed. Contact support if you need help.',
        support: 'Contact support',
        dismiss: 'OK',
        recoverStoredReceipt: 'Review or clear saved deletion status',
        resetStoredReceipt: 'Clear saved deletion status and return home',
        noReceiptTitle: 'Deletion status is unavailable',
        noReceiptMessage: 'There is no saved deletion receipt to check. Contact support if you need help.',
        storedReceiptInvalidMessage: 'The saved deletion status is incomplete or from an older version. Clear it before starting another deletion request.',
        retryMessage: 'The status could not be checked. We will try again shortly.',
      },
    },
    logout: 'Log out',
    logoutDialog: {
  ...
  team: {
    ...
    manage: {
      ...
      messages: {
        ...
        assignAdminConfirm: 'Make {name} the team lead?',
  ...
  profilePhoto: {
    ...
    deleteTitle: 'Use default image',
    deleteConfirm: 'Change your profile photo to the default image?',
    deleted: 'Your profile photo is now set to the default image.',
    deleteFailed: 'Failed to change your profile photo to the default image.',
  },
  pwaInstallGuide: {
  ...
  admin: {
    ...
    memberDetail: {
      ...
      suspension: {
        ...
        suspendConfirm: 'Suspend {name}? They will be blocked from signing in and every existing session is revoked.',
        unsuspendConfirmTitle: 'Lift suspension',
        unsuspendConfirm: 'Lift the suspension on {name}?',
        suspendSuccess: '{name} has been suspended.',
        suspendFailed: 'Failed to suspend the account.',
        unsuspendSuccess: 'The suspension on {name} has been lifted.',
        unsuspendFailed: 'Failed to lift the suspension.',
        working: 'Working...',
      },
    },
    reports: {
      title: 'Report management',
      totalReports: '{count} reports total',
      ...
      row: {
        reportedMember: 'Reported: {name}',
        reporter: 'Reported by {name}',
      },
      messages: {
        loadFailed: 'Failed to load the report list.',
        loadDetailFailed: 'Failed to load the report details.',
        updateStatusSuccess: 'The report status has been updated.',
        updateStatusFailed: 'Failed to update the report status.',
        deleteTargetConfirm: 'Delete the reported content from {name}? This cannot be undone.',
        deleteTargetSuccess: 'The reported content has been deleted.',
        deleteTargetFailed: 'Failed to delete the content.',
      },
      detail: {
        title: 'Report details',
        subtitle: 'Report content and moderation',
        closeAria: 'Close report details',
        loadingMessage: 'Loading the report details...',
        retry: 'Try again',
        actionsTitle: 'Actions',
        memoPlaceholder: 'Record what you did (optional)',
        targetDeleted: 'The reported content has already been deleted.',
        memberTargetNotDeletable: 'Member reports are handled by suspending the account instead of deleting content.',
        fields: {
          reportedAt: 'Reported at',
          targetId: 'Target ID',
          reporter: 'Reporter',
          reportedMember: 'Reported member',
          detail: 'Reporter notes',
          snapshot: 'Content at report time',
          memo: 'Admin memo',
          resolvedAt: 'Handled at',
          resolvedBy: 'Handled by',
        },
        values: {
          noDetail: 'No notes were provided',
          withdrawnMember: 'Deleted account',
          none: '-',
        },
        actions: {
          resolve: 'Resolve',
          dismiss: 'Dismiss',
          deleteTarget: 'Delete content',
    ...
    inquiries: {
      ...
      totalInquiries: '{count} inquiries total',
      empty: 'No inquiries to show',
      pagination: '{start}-{end} of {total}',
      filters: {
        open: 'Open',
        closed: 'Closed',
      ...
      messages: {
        loadFailed: 'Failed to load the inquiry list.',
      ...
      detail: {
        ...
        subtitle: 'Inquiry content and handling',
        closeAria: 'Close inquiry details',
        loadingMessage: 'Loading the inquiry details...',
        retry: 'Try again',
        actionsTitle: 'Actions',
        memoPlaceholder: 'Record what you did (optional)',
  ...
  support: {
    ...
    guide: {
      ...
      reportTitle: 'Report',
      reportDescription: 'Open another member\'s calendar and use the ⋯ menu at the top right to report the user, or use the report button on an individual schedule or to-do. Reporting requires you to be signed in.',
      blockTitle: 'Block',
      blockDescription: 'Block someone from the ⋯ menu on a friend card in Friends, or from the ⋯ menu on their calendar. Blocking removes the friendship and hides both calendars from each other, along with search, friend requests and notifications. Duty rosters shared with the same team stay visible. You can unblock from the Friends page.',
      handlingTitle: 'How we handle reports',
      handlingDescription: 'We review every report within 24 hours and take action such as deleting the content or suspending the account.',
      appealDescription: 'If your account has been suspended, you can appeal with the form below.',
    ...
    form: {
      ...
      contentPlaceholder: 'Tell us what you need help with, in as much detail as you can.',
      submit: 'Send inquiry',
      submitting: 'Sending...',
      error: {
        email: 'Enter a valid e-mail address.',
        content: 'Enter your message.',
        rateLimit: 'Too many inquiries have been submitted. Please try again in a little while.',
        generic: 'We could not submit your inquiry. Please try again in a little while.',
      },
    },
    success: {
