...
- [-] 앱 안에서 회원 탈퇴를 시작하고 완료할 수 있게 한다. 구현 완료, TestFlight 실기기·웹 UI·심사 문서 검증이 남아 있다. ([상세](./02-account-deletion/README.md))
...
- [-] Privacy Manifest에 실제 수집 유형을 선언했다. App Store Connect의 App Privacy 답변을 Release 기준으로 최종 대조해 Publish한다. ([상세](./03-privacy-and-ai-consent/README.md), [제출](./07-app-store-connect/README.md))
