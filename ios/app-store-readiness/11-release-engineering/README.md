...
- 기준일: 2026-08-14
- 상태: development 서명 검증 완료, App Store distribution Archive 미검증
...
- [ ] App Store Connect 앱 레코드와 `io.github.shanepark.dutypark` Bundle ID가 일치하는지 확인한다.
- [ ] App Store distribution certificate와 provisioning profile로 Generic iOS Device **Release Archive**를 생성한다.
...
- [ ] Xcode Organizer의 **Validate App**을 통과하고 warning의 처리 또는 수용 근거를 기록한다.
