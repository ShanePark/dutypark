            ...
            .andDo(
                document(
                    ...
                    responseFields(
                        ...
                        fieldWithPath("duty.source").description("Resolved duty source").optional(),
            ...
            .andDo(
                document(
                    ...
                    responseFields(
                        ...
                        fieldWithPath("friends[].member.profilePhotoVersion").description("Profile photo version for cache busting"),
                        ...
                        fieldWithPath("friends[].duty.source").description("Resolved duty source").optional(),
